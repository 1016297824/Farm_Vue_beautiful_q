    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <!-- 员工管理 -->
          <li class="nav-item">
            <router-link to="/restaurantManager/staffShow2" class="nav-link">
          ...
          <!-- 考勤管理 -->
          <li class="nav-item">
            <router-link to="/restaurantManager/attendance2" class="nav-link">
          ...
          <!-- 报表打印 -->
          <li class="nav-item">
            <router-link to="/restaurantManager/reportForm2" class="nav-link">
          ...
          <li class="nav-item dropdown">
            ...
            >
              <li>
                <router-link
                  to="/restaurantManager/passwordRestaurantManager"
                  class="dropdown-item"
                >
...
export default {
  ...
  data() {
    return {
      username: sessionStorage.getItem("username") || "餐厅管理员"
    };
  },
  mounted() {
    // 导航栏入场动画
