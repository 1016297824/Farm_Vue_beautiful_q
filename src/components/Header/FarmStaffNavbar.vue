<template>
  <nav id="navbar" class="navbar navbar-expand-lg navbar-farm fixed-top">
    <div class="container-fluid">
      <!-- 品牌Logo和名称 -->
      <router-link :to="'/farmStaff'" class="navbar-brand navbar-brand-farm">
        <div class="farm-logo"></div>
        <span>西塘草舍农场</span>
        <small class="d-block">员工管理系统</small>
      </router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <!-- 农产品管理 -->
          <li class="nav-item">
            <router-link to="/farmStaff/productShow" class="nav-link">
          ...
          <li class="nav-item dropdown">
            ...
            <ul
              ...
              aria-labelledby="purchaseDropdown"
            >
              <li>
                <router-link to="/farmStaff/rawMaterial" class="dropdown-item">
              ...
              <li>
                <router-link to="/farmStaff/fertilizer" class="dropdown-item">
              ...
              <li>
                <router-link
                  to="/farmStaff/restaurantMaterial"
                  class="dropdown-item"
                >
          ...
          <!-- 产品销售 -->
          <li class="nav-item">
            <router-link to="/farmStaff/sale" class="nav-link">
          ...
          <li class="nav-item dropdown">
            ...
            >
              <li>
                <router-link
                  to="/farmStaff/passwordFarmStaff"
                  class="dropdown-item"
                >
...
export default {
  ...
  data() {
    return {
      username: sessionStorage.getItem("username") || "农场员工"
    };
  },
  mounted() {
    // 导航栏入场动画
