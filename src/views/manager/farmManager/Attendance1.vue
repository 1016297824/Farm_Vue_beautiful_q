      ...
      <div class="row justify-content-center">
        <div class="col-lg-11">
          <div class="card-farm p-4">
                ...
                <tbody v-if="attendanceList1 && attendanceList1.length > 0">
                  ...
                  >
                    ...
                    <td class="text-center">
                      <span
                        :class="
                          getAttendanceStatusClass(attendance.workingHours)
                        "
                        class="badge"
                      >
            ...
            <!-- 空状态 -->
            <div
              v-if="attendanceList1 && attendanceList1.length === 0"
            ...
            >
              <div class="text-muted">
                ...
                共 {{ attendanceList.length }} 名员工的考勤记录
              </div>
              <button
                type="button"
...
export default {
  ...
  methods: {
    async updateAttendance() {
      try {
        ...
        if (confirmed) {
          ...
          this.showToast("考勤信息提交成功", "success");
        }
      } catch (error) {
    ...
    changeWorkingHours(attendance) {
      ...
      // 显示更改提示
      this.showToast(
        `已更新 ${attendance.staff.name} 的工作时长为 ${attendance.workingHours} 小时`,
        "info"
      );
    },
    ...
    chooseDate() {
      ...
      this.showToast(
        `已切换到 ${this.formatDate(this.choosedDate)} 的考勤数据`,
        "info"
      );
    },
