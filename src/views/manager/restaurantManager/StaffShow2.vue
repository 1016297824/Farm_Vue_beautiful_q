          ...
          <div class="card-farm p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
              <h2 class="farm-title mb-0">
                <i class="bi bi-people me-2"></i>餐厅员工管理
              </h2>
              <button
                type="button"
    ...
    async deleteStaff(name, username) {
      try {
        ...
        if (confirmed) {
          ...
          this.showToast(`员工 ${name} 已成功解雇`, "success");
          getStaff();
        }
      } catch (error) {
        console.error("解雇员工失败:", error);
        this.showToast("解雇失败，请稍后重试", "danger");
      }
    },
    ...
    async takeOffice() {
      try {
        ...
        if (
          ...
          this.showToast("该员工已是此职位！", "warning");
          return;
        }
        ...
        this.showToast("分配失败，请稍后重试", "danger");
      }
    },
